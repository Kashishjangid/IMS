...
const AddInward = ({hiddenaddinward,sendDataToParent,fieldName}) => {
    ...
    const handleAddInwardDetailstoggle = (e) => {
        e.preventDefault();  
    ...
    return (
        <div>
            <div
                className={`absolute flex-grow   top-0 left-[50%] -translate-x-[50%]  ${hiddenaddinward ? "hidden" : "flex"
                    ...
                    <div className="border bg-white p-4 rounded w-[80%] ">
                        <div className="space-y-2">
                            <div className="flex justify-between text-2xl">
                                ...
                                <RxCross2 size={30} 
                                onClick={handleAddInwardDetailstoggle} 
                        ...
                        <form className=" space-y-4 ">
                            <div>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    .map((ele, index) => (
                                        <div className="  md:gap-2 mt-4 space-y-6 md:space-y-0 overflow-hidden">
                                            <div className="space-y-2">
                                                <span>{ele}</span>
